...
* **Use old-style keyboard handling** - this is off by default, and enabling this switches to old-style key input handling style. See [What's new in AGS 3.6](WhatsNewIn36#changes-to-key-input-handling) for more information.
